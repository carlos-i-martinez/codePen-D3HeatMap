...
d3.json(url).then(function (json) {
  ...
  var colorScale = d3.scaleOrdinal().domain([5.5, 6.5, 7.5, 8.5, 9.1]).range(colorHold);
  ...
  // legend text
  var colorLText = ["Below 5.5C", "5.5C to 6.5C", "6.5C to 7.5C", "7.5C to 8.5C", "8.5C to 9.1C", "> 9.1C"];
